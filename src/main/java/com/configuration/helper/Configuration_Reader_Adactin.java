...
public class Configuration_Reader_Adactin {
	...
	public Configuration_Reader_Adactin()throws Throwable {
		...
		File f = new File(
				"C:\\Users\\M.Rajkamal\\apache-maven-3.8.3\\apache-maven-3.8.3\\bin\\October_Adactin_Maven_Project\\src\\main\\java\\com\\configuration\\properties\\Configuration.Properties");		
